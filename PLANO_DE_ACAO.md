...
- **Último commit no remoto:** `ca98e4f` (será atualizado ao push do ajuste de Resultado).
...
Topo do remoto = `ca98e4f`. (recompute sempre com `git fetch` — não confie nesta lista.)
