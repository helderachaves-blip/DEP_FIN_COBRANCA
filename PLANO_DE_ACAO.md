...
- **Pendente de push:** commits da Onda 3 em `homologacao` (feat `43e5727` + commits de sincronia de docs) aguardando push. `origin/homologacao..HEAD` ahead > 0. Push é exclusivo do @devops (`AIOX_ACTIVE_AGENT=devops`).
